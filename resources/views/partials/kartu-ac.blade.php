...
<!-- HERO FEATURE CARD AC {{ $id }} (DESAIN AWAL YANG ELEGAN & LEGA - 40px RADIUS) -->
<div x-data="{ 
        showModal: false, 
    ...
    <!-- 1. TOP HEADER: 64x64 ICON HOLDER + UNIT NAME + BADGES + GEAR BUTTON -->
    <div class="flex items-start justify-between relative z-10 gap-3">
        <div class="flex items-center space-x-4 sm:space-x-5 min-w-0">
            ...
            <div class="space-y-1 min-w-0">
                ...
                <h3 @click="showModal = true" 
                    class="text-2xl sm:text-3xl font-black text-[#1D1616] tracking-tight hover:text-[#D84040] transition cursor-pointer truncate" 
                    x-text="unitName" 
        ...
        <button @click="showModal = true" 
                ...
                class="w-11 h-11 sm:w-12 sm:h-12 rounded-full bg-[#EEEEEE] hover:bg-[#8E1616] hover:text-white text-[#1D1616] border border-[#8E1616]/20 flex items-center justify-center transition-all cursor-pointer shadow-xs hover:scale-105 shrink-0">
    ...
    <!-- 2. NESTED 2-COLUMN METRIC BENTO CARDS (20px Radius) -->
